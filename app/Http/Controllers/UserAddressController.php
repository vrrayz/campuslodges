...
class UserAddressController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'hometown' => 'required|string|min:2|max:100',
            'residential_address' => 'required|string|min:2|max:255',
        ]);
        if ($request->programme != 'Jupeb'){
            $request->validate([
...
//        dd($data);
        ...
        return response()->json($data[$count]->lgas);
//        dd(json($data[13]->lgas));
    }
}
